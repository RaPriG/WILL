...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      return this.amigos.map(function(a){return a.nombre});
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var edad = this.amigos.map(function(a){return a.edad;});
      var sum= edad.reduce((a,b) => {return a+b;});
      var prom= sum/edad.length;
      return prom;
    }
  };
